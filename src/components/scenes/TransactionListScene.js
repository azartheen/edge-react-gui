...
import { TransactionListHeader } from '../themed/TransactionListHeader.js'
...
class TransactionListComponent extends React.Component<Props, State> {
  ...
  renderHeader = () => {
    return this.props.loading ? <ActivityIndicator style={{ flex: 1, alignSelf: 'center' }} size="large" /> : <TransactionListHeader />
  }
